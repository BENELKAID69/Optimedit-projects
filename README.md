...
| **🔐 PKI Hybride (Certify Hub + ADCS)** | Infrastructure de gestion de certificats hybride combinant Let's Encrypt (public) et ADCS (interne) avec TLS Bridging sur IIS/ARR pour le domaine `optimedit.eu`. | [Voir le README](https://github.com/BENELKAID69/Optimedit-projects/blob/main/PKI/03.PKI-Hybride/PKI-Hybride.README.md) |
