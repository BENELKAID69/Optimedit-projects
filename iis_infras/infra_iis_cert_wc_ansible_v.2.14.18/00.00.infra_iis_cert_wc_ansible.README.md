...
| **Ansible Automation** | Moteur d'orchestration et déploiement out-of-band | WinRM / Kerberos / HTTPS |
...
<details>
<summary><b> 📂 Vue des dossiers variables groupe, hosts et roles (Cliquer pour ouvrir)</b></summary>
...
Ce dossier constitue aussi le **cerveau** de l'automatisation. Il se décompose en 5 phases séquentielles strictes orchestrées via Ansible.
