...
# 00.00.infra_iis_cert_wc_ansible.README.md
...
[![Active Directory](https://img.shields.io/badge/Active_Directory-Domain_Services-00153B?style=flat-square&logo=windows&logoColor=white)](https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/get-started/virtual-boot-factoryេង)
...
```mermaid
graph TD
    subgraph Master Ansible (/projets_optimedit)
    ...
    subgraph Infrastructure Cible (optimedit.eu)
...
* **📜 Durcissement SSL/TLS :** Purge des liaisons obsolètes, déploiement automatisé de certificats Wildcard issus de la PKI interne (`ADCS`), et restriction aux protocoles robustes.
